 ...
 *   https://datatables.net/download/#zf-5.5.2/dt-1.10.15/kt-2.2.1/sc-1.4.2
 *
 * Included libraries:
 *   Foundation 5.5.2, DataTables 1.10.15, KeyTable 2.2.1, Scroller 1.4.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"zf-5.5.2/dt-1.10.15/kt-2.2.1/sc-1.4.2",
