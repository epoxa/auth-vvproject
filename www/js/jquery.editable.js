...
(function($, window) {
    ...
    adjustTextAreaHeight = function() {
        ...
        if( $textArea[0].scrollHeight !== parseInt($textArea.attr('data-scroll'), 10) ) {
            ...
            $textArea.attr('data-scroll', $textArea[0].scrollHexight);
            //$textArea.css('height', $textArea[0].scrollHeight +'px');
    ...
    elementEditor = function($el, opts) {
        ...
        var defaultText = $.trim( $el.html() ),
            ...
            textareaStyle = 'box-sizing: border-box; width: 100%; min-height: 18px; padding:0; margin:0; border:0; background:none;' +
                            'resize: none; overflow: hidden; outline: none; box-shadow: none;' +
         ...
         */
            ...
            $textArea
                ...
                .focus()
                //.get(0).select(); // epoxa commented out
